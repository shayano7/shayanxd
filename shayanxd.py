...
__copyright = 'All rights reserved . Copyright  shayan haram!'

CorrectUsername = 'alyan'

CorrectPassword = 'shayan'
...
while (loop == 'true'):
    ...
    if (username == CorrectUsername):
            ...
            os.system('https://www.facebook.com/SHaYaNoHaRaMi007')
